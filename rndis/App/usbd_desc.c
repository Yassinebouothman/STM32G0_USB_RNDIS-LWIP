...
#define USBD_MANUFACTURER_STRING      "Comelit SpA"
#define USBD_PRODUCT_HS_STRING        "SimpleHome Input/Output Module"
#define USBD_PRODUCT_FS_STRING        "SimpleHome Input/Output Module"
